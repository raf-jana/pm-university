                    ...
                    <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
                        ...
                        @foreach($placements as $placement)
                            <tr>
                                ...
                                <td>
                                    <span class="label label-{{activeLabelClass($placement->isPublished())}}">
                                        {{ activeLabelText($placement->isPublished()) }}
                                    </span>
                                </td>
                                <td class="text-right">
                                    <div class="btn-group">
                                        <button class="btn-white btn btn-xs">
                                            <a href="{{ route('placements.edit', [ 'id' => $placement->id ]) }}">
                                                Edit
                                            </a>
                                        </button>
                                        <button class="btn-white btn btn-xs">
                                            <a href="{{'/admin/placements/'.$placement->id}}"
