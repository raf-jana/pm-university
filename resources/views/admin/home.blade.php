                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-stripped">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control" disabled
                                                   value="../../mydomain.com/images/image1.html">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control" disabled
                                                   value="../../mydomain.com/images/image2.html">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control" disabled
                                                   value="../../mydomain.com/images/image3.html">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control" disabled
                                                   value="../../mydomain.com/images/image4.html">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control" disabled
                                                   value="../../mydomain.com/images/image5.html">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control" disabled
                                                   value="../../mydomain.com/images/image6.html">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control" disabled
                                                   value="../../mydomain.com/images/image7.html">
                                        </td>
                                        <td>
